...
const StatisticalPost = () => {
  ...
  const TabButton = ({ icon: Icon, label, tabKey }) => (
    <button
      className={`btn ${
        activeTab === tabKey ? "btn-primary" : "btn-outline-primary"
        ...
        <div className="col-md-6">
          <div className="card h-100 shadow-sm">
            <div className="card-header bg-white border-bottom-0">
              <h5 className="card-title mb-0" style={{ color: PRIMARY_COLOR }}>
                Post Distribution
              </h5>
            </div>
                ...
                <PieChart>
                  <Pie
                    data={[
                      {
                        name: "With Images",
                        value: statistics?.postsWithImages || 0,
                      },
                      {
                        name: "Without Images",
                        value: statistics?.postsWithoutImages || 0,
                      },
                    ]}
                    cx="50%"
                    cy="50%"
  ...
  return (
    <div className="container-fluid py-4">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h1 className="h3 mb-0" style={{ color: PRIMARY_COLOR }}>
