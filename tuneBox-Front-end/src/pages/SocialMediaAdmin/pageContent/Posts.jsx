...
const Posts = () => {
  ...
  const fetchNewPosts = async () => {
    try {
      const response = await axios.get(`http://localhost:8082/admin/posts/new`);
  ...
  const fetchAllPosts = async () => {
    try {
      const response = await axios.get("http://localhost:8082/admin/posts");
  ...
  const fetchCountPosts = async () => {
    try {
      const response = await axios.get(
        "http://localhost:8082/admin/posts/total"
      );
