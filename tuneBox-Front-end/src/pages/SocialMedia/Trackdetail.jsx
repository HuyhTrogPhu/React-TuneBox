      ...
      <div className="container track-page-header">
        <div className="adaptive-content">
          <div className="track-page-player ">
            <img
              src={images.camonnhangiai}
              className="track-page-player-cover-image"
              width={200}
              height={200}
              alt="anh"
            />
            <div className="track-page-player-titles">
              ...
              <div>
                ...
                <span class="hide-for-medium-down">·</span>
                <time
        ...
        <div className="adaptive-content track-player-actions">
            ...
            <img src={images.heart} width={22} height={22}  alt="heart" />
            </button>
            <button className="btn">
            <img src={images.share} width={22} height={22}  alt="heart" />
            share
            </button>
            </div>
            <div class="track-player-actions-column">
                <button className="btn">
                    ...
                </button>
            </div>
...
<div className="row mb-2 mt-3">
  <div className="col-md-7 border rounded">
        ...
        <textarea className="comment-input" style={{ resize: 'none' }} rows={1} placeholder="Write a comment..." defaultValue={""} />
