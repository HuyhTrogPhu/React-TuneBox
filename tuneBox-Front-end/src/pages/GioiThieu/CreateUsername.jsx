        ...
        <div className>
          <div className=" d-flex justify-content-center align-items-center user ">
            ...
            <div className="profile-setup-card text-center p-4 rounded-3">
              ...
              <p className="text-muted mb-3 fontchu">Hãy đặt tên người dùng để bạn bè và mọi người dễ dàng tìm kiếm bạn trên TuneBox.</p>
              ...
              <div className="mb-3">
                <input type="text" className="form-control l1" defaultValue />
              </div>
              <button className="btn btn-dark w-100"> Tiếp tục</button>
            </div>
          </div>
        </div>
      </div>
