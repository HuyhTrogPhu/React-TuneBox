...
const handleUpdateUserInfo = async () => {
    ...
    if (userIdCookie) {
        const updatedUserInfo = {
            userName, // thuộc tính của User
            userInformation: { // thuộc tính của UserInformation
                name,
                location,
                about,
            },
        ...
        try {
            await updateUserInfo(userIdCookie, updatedUserInfo); // Gửi yêu cầu cập nhật
            ...
            if (error.response && error.response.data && error.response.data.message) {
                ...
                toast.error(error.response.data.message); // Hiển thị thông báo lỗi cụ thể
            } else {
                toast.error("Cập nhật thông tin không thành công."); // Hiển thị thông báo lỗi mặc định
            }
        }
    }
};
